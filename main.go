...
func chooseIndexHTML(isDev bool) {
	...
	if !isDev {
		gasx.DeleteFile("index.dev.html")
		gasx.DeleteFile("index.prod.html")
	}
}
...
func compileStyles(builder *gasx.Builder, acssGen acss.Generator, isDev bool) {
	...
	if !isDev {
		gasx.RunCommand("csso dist/acss.css -o dist/acss.m.css")
		gasx.RunCommand("csso dist/main.css -o dist/main.m.css")
		gasx.RunCommand("csso dist/deps.css -o dist/deps.m.css")
	}
}
